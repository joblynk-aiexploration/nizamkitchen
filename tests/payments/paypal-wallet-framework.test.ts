...
describe("PayPal and wallet gateway framework", () => {
  beforeEach(() => {
    ...
    mockPrisma.paymentOrder.findUniqueOrThrow.mockResolvedValue({ id: "payment-order-1", provider: "paypal", providerOrderId: "paypal-order-1", organizationId: "org-1", countryCode: "US", currencyCode: "USD", amount: new Prisma.Decimal(25), gatewayId: "gateway-paypal" });

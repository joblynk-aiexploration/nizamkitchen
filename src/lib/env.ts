...
const envSchema = z.object({
  ...
  MAPTILER_RESTAURANT_DISCOVERY_ENABLED: z.coerce.boolean().default(false),
...
export function validateEnv(raw: NodeJS.ProcessEnv) {
  return envSchema.safeParse({
    ...
    MAPTILER_API_KEY: raw.MAPTILER_API_KEY,
    NEXT_PUBLIC_MAPTILER_API_KEY: raw.NEXT_PUBLIC_MAPTILER_API_KEY,
    MAPTILER_RESTAURANT_DISCOVERY_ENABLED: raw.MAPTILER_RESTAURANT_DISCOVERY_ENABLED,

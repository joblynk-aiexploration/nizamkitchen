...
export default async function ChefVerificationPage({ searchParams }: { searchParams: Promise<{ message?: string }> }) {
  ...
  if (!enabled) return <EmptyState title="Seller verification is disabled" description="Compliance workflows are not enabled for this chef business yet." />;
  ...
  return (
    <div className="space-y-6">
      ...
      <SellerVerificationPage
        title="Chef business verification"
        description="Upload identity, food handler, background consent, and payout readiness documents for admin review."
        profile={profile}

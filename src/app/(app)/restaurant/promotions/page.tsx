...
import { createRestaurantPromotionAction } from "./actions";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        {promotions.length === 0 ? <EmptyState title="No promotions" description="Restaurant promotions you create will appear here." /> : null}

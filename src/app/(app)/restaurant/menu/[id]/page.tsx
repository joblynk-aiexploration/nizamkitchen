...
export default async function RestaurantMenuDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8">
      <PageHeader eyebrow="Restaurant" title={menu.name} description="Edit restaurant menu details and review attached dishes." />
      <MenuForm action={upsertRestaurantMenuAction} menu={menu} />
      <Card>

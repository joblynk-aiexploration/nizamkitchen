...
export const generateMetadata = () => publicPageMetadata("/for-households");
    ...
    <div className="px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-20 rounded-3xl bg-slate-50 px-8 py-12 text-center">
          ...
          <Link
            href="/features"
            className="mt-6 inline-flex min-h-11 rounded-2xl bg-[var(--button-primary-bg)] px-8 py-3 text-sm font-semibold text-[var(--button-primary-text)] shadow-sm transition hover:bg-[var(--button-primary-hover-bg)]"
          >

...
const iconByHref = {
  ...
  "/catering/fulfillment": ShoppingCart,
  "/catering/promotions": Store,
  ...
  "/restaurant/fulfillment": ShoppingCart,
  "/restaurant/promotions": Store,
  ...
  "/admin/apis": Cog,
  "/admin/seo": Search,
  "/admin/localization": MapPinned,
  "/admin/accounting": CircleDollarSign,
